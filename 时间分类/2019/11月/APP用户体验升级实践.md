...
* [1,让APP好看起来-样式优化](#1让APP好看起来-样式优化)
  * [1.1,选择一个主题色](#1.1选择一个主题色)
  * [1.2,简约,即是美](#1.2简约,即是美)
    * [1.2.1,页面中功能太多](#1.2.1页面中功能太多)
    * [1.2.2,功能命名烂而且没注释](#1.2.2,功能命名烂而且没注释)
    * [1.2.3,功能注释太多](#1.2.3功能注释太多)
    * [1.2.4,功能组织不合理](#1.2.4功能组织不合理)
  * [1.3,背景色,线条,阴影,元素间距](#1.3背景色,线条,阴影,元素间距)
...
那么如何塑造属于自己APP的风格呢?和人一样,每个人的一言一行都是它的风格表现,APP的每个元素的样式,每个场景的交互方式,每个动画的效果都是他的风格。
...
**我的APP的主题色**:继(chao)承(xi)自支付宝的沉着冷静,成熟稳重。但更加鲜活,代表着我的APP更有活力(我喜欢有活力的感觉)。(我的APP业务:支付,商户收款)(请不要嘲笑我的主题色是chaoxi了一点支付宝的,同样是支付领域,类似的主题色能够让客户形成"我们的APP是和支付一样让人值得放心的"的感觉)
...
美的代码是逻辑清晰的,命名好的,注释充分但不累赘的。

美的APP是功能清晰的,命名好的,注释充分但不累赘的。
...
逻辑清晰的代码是根据代码逻辑将代码分成多个代码块后的代码。

功能清晰的APP(在样式层)是根据其使用场景将功能分成多个功能块后的功能。
...
美的APP是干净的,在美的APP中,屏幕中的元素并不是散乱的,而是有其相互联系的。
...
前端错误提示设计,在前端,将错误提示UI渲染方法,接口是否执行成功逻辑判断,接口执行失败后返回怎样的错误码,页面中的错误提示等都抽取出来统一管理,统一维护。
...
统计功能的使用情况,有助于调整功能的入口深度, 针对使用频率高的功能做针对性的优化和扩展等。
